...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sidebar::before { content:''; position:absolute; top:-80px; left:-80px; width:320px; height:320px; background:radial-gradient(circle, rgba(139,92,246,0.1) 0%, transparent 65%); pointer-events:none; }

        .sidebar-brand { padding:20px 18px 14px; display:flex; align-items:center; gap:11px; flex-shrink:0; }
        .brand-icon { width:36px; height:36px; border-radius:10px; background:rgba(139,92,246,0.12); border:1px solid rgba(139,92,246,0.22); display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .brand-icon .material-symbols-rounded { font-size:18px; color:#8b5cf6; }
        ...
        .live-dot { width:6px; height:6px; border-radius:50%; background:#8b5cf6; flex-shrink:0; animation:live-pulse 2.8s ease-in-out infinite; }
        @keyframes live-pulse { 0%,100% { opacity:1; box-shadow:0 0 0 0 rgba(139,92,246,0.45); } 60% { opacity:.6; box-shadow:0 0 0 5px rgba(139,92,246,0); } }
        ...
        .nav-item.active { background:rgba(139,92,246,0.1); color:#8b5cf6; font-weight:600; }
        ...
        .user-avatar { width:28px; height:28px; border-radius:50%; background:rgba(139,92,246,0.18); border:1px solid rgba(139,92,246,0.28); display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:700; color:#8b5cf6; flex-shrink:0; font-family:'Syne',sans-serif; }
        ...
        .dot-input:focus { border-color:rgba(139,92,246,0.45); box-shadow:0 0 0 3px rgba(139,92,246,0.07); }
        ...
        .dot-btn-primary { background:#8b5cf6; color:#09090b; }
        ...
        .dot-badge-accent { background:rgba(139,92,246,0.12); color:#8b5cf6; }
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                <div class="brand-name">Dot.docs</div>
                <div class="brand-status">
                    <div class="live-dot"></div>
                    <span class="brand-subtitle">Document Suite</span>
                </div>
            </div>
        </div>
    ...
    <header class="topbar">
        <div class="topbar-title">
            @isset($header){{ $header }}@else Dot.docs
            @endisset
        </div>
        @auth
